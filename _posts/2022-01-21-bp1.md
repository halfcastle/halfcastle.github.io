...
def conn(month, year, country1, country2, **kwargs):
    ...
    **kwargs: additional keyword arguments passed to px.scatter_3d
    ...
    fig = px.scatter(dfn,
                       ...
                       hover_name = "NAME",
                       opacity=0.5,
                       title="Comparing how latitude affects temperature in " + calendar.month_name[month] + " for stations in "
...
https://raw.githubusercontent.com/halfcastle/halfcastle.github.io/master/images/climates.png
