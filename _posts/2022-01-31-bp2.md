...
flask run
```
to get the url to access our website.
...
1. **The random_messages(n) function**, which returns a collection of n random messages from our messages database
...
2. **The view.html file** to display our messages. It will also be an extension to our main page.
...
3. **The viewy() function**, which allows users to view a random set of n messages
